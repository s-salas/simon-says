...
function playHumanTurn() {
  ...
  statusSpan.textContent = `${computerSequence.length - playerSequence.length} remaining presses left in this round`;
}
...
/**
 * Checks each round to see if the player has completed all the rounds of the game * or advance to
 * the next round if the game has not finished.
 *
